...
def run():
            ...
            if bookmaker["key"] in ["fanduel", "draftkings"]:  # Filter for FanDuel & DraftKings
                ...
                for market in bookmaker["markets"]:
                    if market["key"] in stat_categories:  # Extract relevant stats
                        ...
                        url = "https://nba-bet-api-gpafdhhmg9bxgbce.centralus-01.azurewebsites.net/api/linepredictions"
    ...
    return f"Betting Lines data processed successfully for {game_date} data."
